function init(){
	...
	glow =  mobile ? loader.load("glow_mobile.png") : loader.load("glow_mobile.png");
...
function shaderInit(){
	uniforms = {
		...
		fogNear: { type: "1f", value: scene.fog.near*250 },
...
function addSkybox(){
	var materialArray = [],
        imgArray = mobile ? ["skybox_right_mobile.jpg", "skybox_left_mobile.jpg",
        "skybox_front_mobile.jpg", "skybox_back_mobile.jpg",
        "skybox_bottom_mobile.jpg", "skybox_top_mobile.jpg"] : ["skybox_right.jpg", "skybox_left.jpg",
...
function addTunnel(){
	var cylTexture = mobile ? loader.load("wormhole2_mobile.png") : loader.load("wormhole2.png"),
...
function addBlock(){
	...
	block.position.z = -33000;
	glowMesh.position.z = -33000;
...
function render() {
	...
	if (!paused) {
    	...
    	var f01 = frequencyAvg*0.01,
    		f0001 = frequencyAvg*0.0001;

	    updateObjects(frequencyAvg*3.5, f01);
	    TWEEN.update();
	    if (!gameOver) {
	    	octree.update();
		    octree.rebuild();
	    ...
	    skybox.rotation.z -= f0001;
	    tunnel.material.map.offset.y += f0001;
	    tunnel.material.map.offset.x += frequencyAvg*0.00005;
	    tunnel.material.opacity = f01;
	    tunnelCap.material.opacity = f01;
    }
